...
public class EmailConstant {
    ...
    public static final String USERNAME = "atadurdyyewserdar";
    public static final String PASSWORD = "blrcmhuctcndaasf";
    public static final String FROM_EMAIL = "atadurdyyewserdar@gmail.com";
